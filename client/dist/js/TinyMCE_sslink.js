...
var plugin = {
  init: function init(editor) {
    ...
    editor.on('preinit', function () {
      (0, _TinymceInlineToolbar.setupTinyMceInlineToolbar)(editor, [{ type: 'button', onClick: openLinkDialog, text: _i18n2.default._t('Admin.EDIT_LINK', 'Edit link') }, { type: 'button', onClick: function onClick() {
          return _this.handleRemoveLinkClick(editor);
        }, text: _i18n2.default._t('Admin.REMOVE_LINK', 'Remove link') }], ['a[href]']);
    });
  },
...
_jquery2.default.entwine('ss', function ($) {
  $('.insert-link__dialog-wrapper').entwine({
    ...
    buildAttributes: function buildAttributes(_ref) {
      ...
      var anchor = Anchor && Anchor.length ? '#' + Anchor : '';

      anchor = anchor.replace(/^#+/, '#');
      var href = '' + Link + anchor;
