...
var o=n(5),i=r(o),a=n(2),u=r(a),c=n(6),s=r(c),f=n(3),l=r(f),d=n(7),p=n(4),h=r(p),y=n(8),v=n(13)
u.default.addAction("sslink",{text:i.default._t("Admin.LINKLABEL_EXTERNALURL","Link to external URL"),onclick:function e(t){return t.execCommand("sslinkexternal")}})
var m={init:function e(t){t.addCommand("sslinkexternal",function(){var e=window.jQuery("#"+t.id).entwine("ss")
e.openLinkExternalDialog()})}},b="insert-link__dialog-wrapper--external",w="SilverStripe\\Admin\\LeftAndMain",_="EditorExternalLink",g=(0,v.provideInjector)((0,y.createInsertLinkModal)(w,_))
...
l.default.render(s.default.createElement(d.ApolloProvider,{store:r,client:o},s.default.createElement(g,{show:t,onInsert:u,onHide:a,title:i.default._t("Admin.LINK_EXTERNAL","Insert external link"),bodyClassName:"modal__dialog",
className:"insert-link__dialog-wrapper--external",fileAttributes:c})),this[0])},buildAttributes:function e(t){var n=this._super(t),r=n.href
...
r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(t,n,r){return n&&e(t.prototype,n),r&&e(t,r),t}}(),d=n(6),p=o(d),h=n(9),y=n(10),v=n(11),m=o(v),b=n(12),w=r(b),_=function(e){
...
var g=function e(t,n){function r(e){var r=e.config.sections.find(function(e){return e.name===t}),o=""+r.form[n].schemaUrl
return{sectionConfig:r,schemaUrl:o}}return(0,y.connect)(r,c)(_)}
t.InsertLinkModal=_,t.createInsertLinkModal=g,t.default=(0,y.connect)(function(){return{}},c)(_)},,,function(e,t){e.exports=FormBuilderModal},function(e,t){e.exports=SchemaActions},function(e,t,n){"use strict"
...
for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e},a=n(19),u=r(a),c=n(9),s={},f={},l="before",d="after",p="__HEAD__",h="__TAIL__",y=[l,d],v=!1,m=function e(t){y.forEach(function(e){
if("undefined"!=typeof t[e]&&"string"!=typeof t[e]&&!Array.isArray(t[e]))throw new Error("Injector.update() key "+e+" must be a string or array")})},b=function e(t){return function(){if(v)throw new Error("Cannot mutate DI container after it has been initialised")


t.apply(void 0,arguments)}},w=function e(t,n){var r=t.displayName||t.name||"Component",i=[r].concat(o(n))
return i.reduce(function(e,t){return t+"("+e+")"})},_=function e(t){return t.map(function(e){var t=i({},e)
return y.forEach(function(n){Array.isArray(e[n])?t[n]=e[n]:t[n]=e[n]?[e[n]]:[]}),y.every(function(e){return!t[e].length})&&(t[d]=[p],t[l]=[h]),t})},g=function e(t){var n=null
...
n=e}}),n},O=function e(t){var n=[p,h],r=[n],o=[],i=_(t)
return i.forEach(function(e){var t=e.name,n=g(e)
...
}).forEach(function(e){o=o.concat(t.filter(function(t){return t.name===e}))}),o},j=function e(t){t||console.warn("\n      Injector.__reset__() should only be used in dev mode. Using\n      this method in production will likely break.\n    "),
[s,f].forEach(function(e){Object.keys(e).forEach(function(t){return delete e[t]})}),v=!1},E=function e(t,n,r){m(t),s[n]||(s[n]=[]),s[n].push(i({},t,{factory:r}))},k=function e(t,n){var r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:{}
...
m(o),n(function(e,t,n){E(i({},o,{displayName:n}),e,t)})},x=function e(){Object.keys(s).forEach(function(e){if(s.hasOwnProperty(e)){var t=O(s[e]),n=f[e],r=t.map(function(e){return e.factory}),i=t.map(function(e){
return e.displayName||e.name}),a=c.compose.apply(void 0,o(r))(n)
a.displayName=w(n,i),f[e]=a}}),v=!0},I={get:P,load:x,transform:b(A),register:b(k)}
t.default=I},function(e,t){function n(e,t){function n(a,u,c){if(c.indexOf(a)>=0)throw new Error("Cyclic dependency: "+JSON.stringify(a))
...
=======
webpackJsonp([1],{120:function(e,t){e.exports=ReactApollo},147:function(e,t){e.exports=FormBuilderModal},148:function(e,t){e.exports=SchemaActions},176:function(e,t,n){"use strict";function r(e){return e&&e.__esModule?e:{default:e}}function i(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function o(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function a(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}function s(e){return{actions:{schema:(0,d.bindActionCreators)(y,e)}}}Object.defineProperty(t,"__esModule",{value:!0}),t.createInsertLinkModal=t.InsertLinkModal=void 0;var l=function(){function e(e,t){var n=[],r=!0,i=!1,o=void 0;try{for(var a,s=e[Symbol.iterator]();!(r=(a=s.next()).done)&&(n.push(a.value),!t||n.length!==t);r=!0);}catch(e){i=!0,o=e}finally{try{!r&&s.return&&s.return()}finally{if(i)throw o}}return n}return function(t,n){if(Array.isArray(t))return t;if(Symbol.iterator in Object(t))return e(t,n);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}(),u=function(){function e(e,t){for(var n=0;n<t.length;n++){var r=t[n];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(t,n,r){return n&&e(t.prototype,n),r&&e(t,r),t}}(),c=n(0),f=r(c),d=n(51),p=n(43),h=n(147),m=r(h),v=n(148),y=function(e){if(e&&e.__esModule)return e;var t={};if(null!=e)for(var n in e)Object.prototype.hasOwnProperty.call(e,n)&&(t[n]=e[n]);return t.default=e,t}(v),b=function(e){function t(e){i(this,t);var n=o(this,(t.__proto__||Object.getPrototypeOf(t)).call(this,e));return n.handleSubmit=n.handleSubmit.bind(n),n.setOverrides(e.show?e:null),n}return a(t,e),u(t,[{key:"componentWillReceiveProps",value:function(e){(e.show&&!this.props.show||!e.show&&this.props.show)&&this.setOverrides(e.show?e:null)}},{key:"componentWillUnmount",value:function(){this.setOverrides()}},{key:"setOverrides",value:function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null;if(e){if(e.schemaUrl){var t=Object.assign({},e.fileAttributes);delete t.ID;var n={fields:Object.entries(t).map(function(e){var t=l(e,2);return{name:t[0],value:t[1]}})};this.props.actions.schema.setSchemaStateOverrides(e.schemaUrl,n)}}else{var r=e&&e.schemaUrl||this.props.schemaUrl;r&&this.props.actions.schema.setSchemaStateOverrides(r,null)}}},{key:"getModalProps",value:function(){var e=Object.assign({},this.props,{handleSubmit:this.handleSubmit,handleHide:this.props.onHide});return delete e.onHide,delete e.onInsert,delete e.sectionConfig,e}},{key:"handleSubmit",value:function(e,t){switch(t){case"action_cancel":this.props.onHide();break;default:this.props.onInsert(e,t)}return Promise.resolve()}},{key:"render",value:function(){var e=this.getModalProps();return f.default.createElement(m.default,e)}}]),t}(c.Component);b.propTypes={show:c.PropTypes.bool,schemaUrl:c.PropTypes.string,onInsert:c.PropTypes.func.isRequired,onHide:c.PropTypes.func.isRequired,actions:c.PropTypes.object},b.defaultProps={};var w=function(e,t){function n(n){var r=n.config.sections.find(function(t){return t.name===e});return{sectionConfig:r,schemaUrl:""+r.form[t].schemaUrl}}return(0,p.connect)(n,s)(b)};t.InsertLinkModal=b,t.createInsertLinkModal=w,t.default=(0,p.connect)(function(){return{}},s)(b)},24:function(e,t){e.exports=i18n},899:function(e,t,n){"use strict";function r(e){return e&&e.__esModule?e:{default:e}}Object.defineProperty(t,"__esModule",{value:!0});var i=n(24),o=r(i),a=n(97),s=r(a),l=n(0),u=r(l),c=n(28),f=r(c),d=n(120),p=n(26),h=r(p),m=n(176);s.default.addAction("sslink",{text:o.default._t("Admin.LINKLABEL_EXTERNALURL","Link to external URL"),onclick:function(e){return e.execCommand("sslinkexternal")}});var v={init:function(e){e.addCommand("sslinkexternal",function(){window.jQuery("#"+e.id).entwine("ss").openLinkExternalDialog()})}},y="insert-link__dialog-wrapper--external",b=(0,m.createInsertLinkModal)("SilverStripe\\Admin\\LeftAndMain","EditorExternalLink");h.default.entwine("ss",function(e){e("textarea.htmleditor").entwine({openLinkExternalDialog:function(){var t=e("#"+y);t.length||(t=e('<div id="'+y+'" />'),e("body").append(t)),t.addClass("insert-link__dialog-wrapper"),t.setElement(this),t.open()}}),e("#"+y).entwine({renderModal:function(e){var t=this,n=ss.store,r=ss.apolloClient,i=function(){return t.close()},a=function(){return t.handleInsert.apply(t,arguments)},s=this.getOriginalAttributes();f.default.render(u.default.createElement(d.ApolloProvider,{store:n,client:r},u.default.createElement(b,{show:e,onInsert:a,onHide:i,title:o.default._t("Admin.LINK_EXTERNAL","Insert external link"),bodyClassName:"modal__dialog",className:"insert-link__dialog-wrapper--external",fileAttributes:s})),this[0])},buildAttributes:function(e){var t=this._super(e),n=t.href;return n.match(/:\/\//)||(n=window.location.protocol+"//"+n),n=n.replace(/:\/\/(#.*)$/,"$2"),n.match(/:\/\/$/)&&(n=""),t.href=n,t}})}),tinymce.PluginManager.add("sslinkexternal",function(e){return v.init(e)}),t.default=v},97:function(e,t,n){"use strict";function r(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(t,"__esModule",{value:!0});var i=function(){function e(e,t){for(var n=0;n<t.length;n++){var r=t[n];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(t,n,r){return n&&e(t.prototype,n),r&&e(t,r),t}}(),o=function(){function e(){r(this,e),this.actions={}}return i(e,[{key:"addAction",value:function(e,t){this.actions[e]=this.getActions(e).concat([t])}},{key:"getActions",value:function(e){return this.actions[e]||[]}}]),e}();window.ss=window.ss||{},window.ss.tinymceactions=window.ss.tinymceactions||new o,t.default=window.ss.tinymceactions}},[899]);
