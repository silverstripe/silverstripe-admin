    ...
    >
      ...
      {numChildren > 0 && (
        <button
          ...
          role="menuitem"
        >
          {i18n._t('CMS.SHOW_AS_LIST', 'Show children as list')}
        </button>
      )}
      ...
      {canEdit && allowedChildren.length > 0 && (
        ...
        >
          <span>{i18n._t('CMS.ADD_PAGE', 'Add page under this page')}</span>
      ...
      {canEdit && (
        ...
        >
          <span>{i18n._t('CMS.DUPLICATE', 'Duplicate')}</span>
          <span className={`${CSS_CLASS}__arrow`}>›</span>
            ...
            >
              {contextMenuUrls?.duplicate && (
                <button
                  ...
                  role="menuitem"
                >
                  {i18n._t('CMS.DUPLICATE_PAGE_ONLY', 'This page only')}
                </button>
              )}
              {contextMenuUrls?.duplicateWithChildren && (
                <button
                  ...
                  role="menuitem"
                >
                  {i18n._t('CMS.DUPLICATE_PAGE_SUBPAGES', 'This page and subpages')}
                </button>
              )}
            </div>
          )}
