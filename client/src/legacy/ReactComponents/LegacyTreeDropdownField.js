...
const ConnectedLegacyTreeDropdownField = connect(mapStateToProps, mapDispatchToProps)(LegacyTreeDropdownField);

export {
  LegacyTreeDropdownField as Component,
  ConnectedLegacyTreeDropdownField,
  MULTI_EMPTY_VALUE,
  SINGLE_EMPTY_VALUE,
  findTreePath,
  findTreeByID,
...
export default fieldHolder(ConnectedLegacyTreeDropdownField);
